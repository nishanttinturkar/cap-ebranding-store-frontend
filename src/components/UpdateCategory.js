...
import { getCategoryById, updateCategory } from '../redux/category/categoryActions';
            ...
            <button
              ...
              onClick={(e) => {
                ...
                if (!isValid) {
                  ...
                  navigate("/categories/show-categories")
                }
              }
              }>Update Category</button>
            <Link className="btn btn-outline-primary m-3" to='/categories'>Cancel</Link>
          </div>
        </form>
      </div>
    </div>
